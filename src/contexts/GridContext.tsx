...
import { createEmptyMatrix, transposeMatrix, DEFAULT_COLORS } from '../utils/grid.ts';
import { getStoredLanguage, getText } from '../utils/language.ts';
    ...
    switch (action.type) {
        ...
        case 'REMOVE_COLOR': {
            ...
            return {
                ...
                colors: newColors,
                selectedColor:
                    state.selectedColor === removedColor && newColors.length > 0
                        ? newColors[0]
                        : state.selectedColor,
            };
        }
        ...
        case 'UPDATE_COLOR': {
            ...
            return {
                ...
                colors: newColors,
                selectedColor:
                    state.selectedColor === state.colors[index] ? color : state.selectedColor,
            };
        }
