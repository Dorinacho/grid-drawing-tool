...
export const ConfirmationModal: React.FC<ConfirmationModalProps> = ({
        ...
        switch (action) {
            case 'update':
                return {
                    ...
                    message:
                        getText('confirmUpdateMessage', language) ||
                        'Are you sure you want to update the grid? This will clear all current symbols and colors.',
            ...
            case 'clear':
                return {
                    ...
                    message:
                        getText('confirmClearMessage', language) ||
                        'Are you sure you want to clear the grid? This will remove all symbols and colors from all cells.',
    ...
    return (
        <>
            ...
            >
                {/* Modal Content - eslint-disable-next-line jsx-a11y/no-noninteractive-element-interactions */}
                <div
                        ...
                        <div className="mb-6 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                            <div className="flex items-start gap-2">
                                ...
                                <p className="text-sm text-yellow-800">
                                    {getText('warningMessage', language) ||
